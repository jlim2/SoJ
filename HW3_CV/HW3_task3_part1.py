        ...
        while (not buttons.any()):
            ...
            if self.pixy.value(0) != 0:
                while True:
	                ...
	                if (self.pixy.value(2) > 80 and self.pixy.value(2) < 180) and (self.pixy.value(3) > 80 and self.pixy.value(3) < 120) and (self.pixy.value(4) > 130 and self.pixy.value(4) < 180):
